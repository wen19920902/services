...
public class FacilityLandTask implements QueueObject {
	...
	static FacilityLandTask creation() {
		return Builder.Task;
	}

	private static class Builder {
		private static FacilityLandTask Task = new FacilityLandTask();
	}
