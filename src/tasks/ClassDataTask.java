...
public class ClassDataTask implements QueueObject {
	...
	static ClassDataTask creation() {
		return Builder.Task;
	}

	private static class Builder {
		private static ClassDataTask Task = new ClassDataTask();
	}
